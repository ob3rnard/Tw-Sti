...
for m in "$@"; do
    ...
    echo "Geometric evaluation of Sti-TwPHS lattices for Q(z$m) [#orbs=$d,$sat,$su] (raw/lll/bkz-40)";
    ${EXE_DIR}/eval_geo.sage ${DATA_DIR} $nf $d $sat $su 1>${LOGS_DIR}/$nf.geolog 2>&1 &
done;
